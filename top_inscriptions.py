...
def get_nostr_info(data_list):
    ...
    for ticker in inscriptions['btc']['lighting']:
        ...
        data_list.append([ticker,'btc','lighting',price*sat_price,dict[ticker]['totalSupply']*price*sat_price,dict[ticker]['tfChange'],dict[ticker]['tfTotalPrice']*sat_price, website])
